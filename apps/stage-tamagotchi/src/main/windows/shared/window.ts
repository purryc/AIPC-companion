...
import { createAppService, createDesktopContextService, createPowerMonitorService, createScreenService, createWindowService } from '../../services/electron'
...
export async function setupBaseWindowElectronInvokes(params: {
  ...
  createDesktopContextService({ context: params.context })

...
const mouthForm = computed(() => Math.max(-1, Math.min(1, props.mouthForm)))
...
async function loadModel() {
  ...
  try {
    ...
    motionManagerUpdate.register(useMotionUpdatePluginLipSync(mouthOpenSize, nowSpeaking, mouthForm), 'final')
